...
* A version of the [FFmpeg](https://www.ffmpeg.org) library with an AAC decoder capable of decoding Floating Planar -- `fltp` -- material must be in your system. There is a guide in the shairport-sync TROUBLESHOOTING docs (AAC decoder issues) to help you find out if your system has it.
...
## Guides
* A building guide is available at the shairport-sync BUILD guide.
