<!-- Archived from https://roc-streaming.org/toolkit/docs/internals/fec.html (Roc Toolkit docs, Sphinx). Reference material for ondaire design; not part of the product. -->
