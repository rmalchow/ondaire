...
- `controlscript`: Script to control the stream source and read and provide meta data, see [stream_plugin.md](json_rpc_stream_plugin.md)
...
Direct audio capture from PipeWire, see the PipeWire Stream Usage Guide (upstream snapcast docs)
