...
Same request as in [Plugin.Stream.Player.Control](json_rpc_stream_plugin.md#pluginstreamplayercontrol), but with the method `Stream.Control`.
...
See [Plugin.Stream.Player.Control](json_rpc_stream_plugin.md#pluginstreamplayercontrol).
...
Same request as in [Plugin.Stream.Player.SetProperty](json_rpc_stream_plugin.md#pluginstreamplayersetproperty), but with the method `Stream.SetProperty`.
...
See [Plugin.Stream.Player.SetProperty](json_rpc_stream_plugin.md#pluginstreamplayersetproperty).
...
Same notification as in [Plugin.Stream.Player.Properties](json_rpc_stream_plugin.md#pluginstreamplayerproperties), but with the method `Stream.OnProperties`.
