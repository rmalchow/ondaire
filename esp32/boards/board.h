...
#elif defined(CONFIG_ENSEMBLE_BOARD_ESP32S3_HIFI)
#include "board_esp32s3_hifi.h"
#elif defined(CONFIG_ENSEMBLE_BOARD_ESP32S3_AMPED)
#include "board_esp32s3_amped.h"
#elif defined(CONFIG_ENSEMBLE_BOARD_ESP32S3_LOUD)
#include "board_esp32s3_loud.h"
#elif defined(CONFIG_ENSEMBLE_BOARD_ESP32S3_HIFI_PLUS)
#include "board_esp32s3_hifi_plus.h"
#elif defined(CONFIG_ENSEMBLE_BOARD_ESP32S3_LOUDER)
#include "board_esp32s3_louder.h"
#elif defined(CONFIG_ENSEMBLE_BOARD_ESP32S3_LOUDER_PLUS)
#include "board_esp32s3_louder_plus.h"
#elif defined(CONFIG_ENSEMBLE_BOARD_ESP32S3_LOUD_PLUS)
