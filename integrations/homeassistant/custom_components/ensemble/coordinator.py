...
class EnsembleCoordinator(DataUpdateCoordinator[Snapshot]):
    ...
    def __init__(
        self, hass: HomeAssistant, entry: ConfigEntry, client: EnsembleClient
    ) -> None:
        super().__init__(
            hass,
            _LOGGER,
    ...
    async def _ws_loop(self) -> None:
        ...
        while True:
            ...
            try:
                ...
                _LOGGER.debug("ensemble WS error: %s", err)
            finally:
    ...
    async def _failover(self) -> None:
        ...
        for origin in candidates:
            ...
            try:
                ...
                _LOGGER.debug("ensemble failed over to %s", origin)
                return
