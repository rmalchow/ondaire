<script>
  ...
  const initialTheme = localStorage.getItem("ondaire-theme") || "mint";
  if (typeof document !== "undefined")
    document.documentElement.dataset.theme = initialTheme;
  let theme = $state(initialTheme);
  $effect(() => {
    document.documentElement.dataset.theme = theme;
    localStorage.setItem("ondaire-theme", theme);
  });
...
<header class="app-header">
  <span class="brand-mark">
    <svg class="brand-lockup" width="105.0" height="42" style="display:block" viewBox="-16.7 -74.0 270.0 108.0"
